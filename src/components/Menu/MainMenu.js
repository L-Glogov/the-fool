      ...
      <div className={styles.rightcont}>
        ...
        <div className={styles.ruleslist}>
          ...
          <ul>
            ...
            <li>On your turn you can play any card (or multiple of the same card), as long as it is higher, or equal to, than the top card of the stack. The active (one that resurrect a new card) bishop and bomb are the only cards which cannot be played in multiples.</li>
